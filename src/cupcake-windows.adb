...
package body Cupcake.Windows is
   ...
   begin
      if Visible and not Has_Element (Window_Cursor) then
         ...
         Backends.Get_Backend.Set_Window_Visibility (
            This.Backend_Data, Visible);
      ...
      then
         ...
         Backends.Get_Backend.Set_Window_Visibility (This.Backend_Data,
            Visible);
   ...
   function Get_Size (This : in Window_Record'Class)
      return Primitives.Dimension is
   begin
      return This.Size;
   end Get_Size;
   ...
   begin
      Backends.Get_Backend.Fill_Area (This.Backend_Data, ((0, 0), This.Size),
         This.Background_Color);
   end Expose_Handler;

   --  Resize event handler:
   procedure Resize_Handler (This : in out Window_Record'Class;
      New_Size : in Primitives.Dimension) is
   begin
      This.Size := New_Size;
   end Resize_Handler;
   ...
   begin
      if Debug_Mode then
         Ada.Text_IO.Put_Line ("[Cupcake.Windows.Post_Expose] "
            ...
            & Backends.Window_ID_Type'Image (This.ID));
      end if;
   ...
   --  Gets the backend data for a visible window or null if no window was
   --  found:
   function Get_Visible_Window (ID : in Backends.Window_ID_Type)
